...
import { rejectVersionSchema } from "@offer-ai/contracts";
...
export async function POST(
  ...
  try {
    ...
    const parsed = rejectVersionSchema.safeParse(merged);
    ...
    const version = await service.rejectVersionForUser(user.id, artifactId, parsed.data.versionId);
